        ...
        <div id="module-config-content" class="modal-content">
            ...
            <div class="settings" style="padding-left: 0; margin-top: 10px;">
                <div class="settings-title fill">
                    ...
                    <span type="text" style="margin-right: 30px">
                        <?php echo _('Tracking'); ?>
                    </span>
            ...
            <div id="module-tracking-settings" class="collapse">
                <div class="settings">
                    <div>
                        <div class="header" style="padding-top: 4px; padding-right: 8px">
                    ...
                    <div class="settings-header">
                        <div><span><?php echo _('Axis height'); ?></span></div>
            ...
            <div id="module-row-settings" class="settings">
                <div class="settings-header">
                    <div><span><?php echo _('Modules'); ?></span></div>
                    <div><span><?php echo _('Stack'); ?></span></div>
                    <div><span class="advanced" style="display: none;"><?php echo _('Gap'); ?></span></div>
                    <div></div>
                </div>
                <div>
            ...
            <div class="module-settings settings" style="padding-left: 0;">
                ...
                <div class="modules-info">
                    <div class="header">
                        <span><?php echo _('Orientation'); ?></span>
                    </div>
                    <div>
                        <select id="module-orientation" class="input-medium" type="text" style="width: 140px" required>
