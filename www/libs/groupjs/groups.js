...
var groups = {
    ...
    'init':function(container) {
        ...
        var actions;
        if (groups.actions["select"] != undefined && groups.actions["select"]) {
    		actions = "<div id='group-action-select-all' class='group-select group-grow'>" +
	                    "<input class='select' type='checkbox'></input>" +
	                    "<span><i>Select all</i></span>" +
	                "</div>";
        }
        else {
        	actions = "<div class='group-grow'></div>"
        }
